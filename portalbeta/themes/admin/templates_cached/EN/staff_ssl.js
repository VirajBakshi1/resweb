...
contextual_css_edit();window.setTimeout(contextual_css_edit,2000);var url_patterns=[{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=authors&type=browse&id=([^&]*)/,hook:'author'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-authors&type=_add&id=([^&]*)/,hook:'author'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=calendar&type=browse&id=([^&]*)/,hook:'calendar_type'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-calendar&type=_edit_category&id=([^&]*)/,hook:'calendar_type'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=catalogues&type=category&id=([^&]*)/,hook:'catalogue_category'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-catalogues&type=_edit_category&id=([^&]*)/,hook:'catalogue_category'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=catalogues&type=entry&id=([^&]*)/,hook:'catalogue_entry'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-catalogues&type=_edit&id=([^&]*)/,hook:'catalogue_entry'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=catalogues&type=index&id=([^&]*)/,hook:'catalogue'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-catalogues&type=_edit_catalogue&id=([^&]*)/,hook:'catalogue'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=chat&type=room&id=([^&]*)/,hook:'chat'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-chat&type=room&id=([^&]*)/,hook:'chat'},{pattern:/^http:\/\/www.coeprobotics.com\/portalbeta\/([^&]*)\/?index.php\?page=-WILD/,hook:'comcode_page'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-comcode-pages&type=_edit&page_link=([^&]*)/,hook:'comcode_page'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=downloads&type=browse&id=([^&]*)/,hook:'download_category'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-downloads&type=_edit_category&id=([^&]*)/,hook:'download_category'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=downloads&type=entry&id=([^&]*)/,hook:'download'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-downloads&type=_edit&id=([^&]*)/,hook:'download'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=calendar&type=view&id=([^&]*)/,hook:'event'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-calendar&type=_edit&id=([^&]*)/,hook:'event'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/forum\/index.php\?page=forumview&type=browse&id=([^&]*)/,hook:'forum'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/adminzone\/index.php\?page=admin-cns-forums&type=_edit_category&id=([^&]*)/,hook:'forum'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=galleries&type=browse&id=([^&]*)/,hook:'gallery'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-galleries&type=_edit_category&id=([^&]*)/,hook:'gallery'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=groups&type=view&id=([^&]*)/,hook:'group'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/adminzone\/index.php\?page=admin-cns-groups&type=_edit&id=([^&]*)/,hook:'group'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=galleries&type=image&id=([^&]*)/,hook:'image'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-galleries&type=_edit&id=([^&]*)/,hook:'image'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=members&type=view&id=([^&]*)/,hook:'member'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=news&type=browse&id=([^&]*)/,hook:'news_category'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-news&type=_edit_category&id=([^&]*)/,hook:'news_category'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=news&type=view&id=([^&]*)/,hook:'news'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-news&type=_edit&id=([^&]*)/,hook:'news'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=polls&type=view&id=([^&]*)/,hook:'poll'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-polls&type=_edit&id=([^&]*)/,hook:'poll'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/forum\/index.php\?page=topicview&type=findpost&id=([^&]*)/,hook:'post'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/forum\/index.php\?page=topics&type=edit_post&id=([^&]*)/,hook:'post'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=quiz&type=do&id=([^&]*)/,hook:'quiz'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-quiz&type=_edit&id=([^&]*)/,hook:'quiz'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/forum\/index.php\?page=topicview&type=browse&id=([^&]*)/,hook:'topic'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/forum\/index.php\?page=topics&type=edit_topic&id=([^&]*)/,hook:'topic'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/site\/index.php\?page=galleries&type=video&id=([^&]*)/,hook:'video'},{pattern:/^https:\/\/www.coeprobotics.com\/portalbeta\/cms\/index.php\?page=cms-galleries&type=_edit_other&id=([^&]*)/,hook:'video'}];var cells=document.getElementsByTagName('td');var links=[];if(window.location.href.replace('/portalbeta','').indexOf('/cms/')!=-1)
...
{link.is_over=true;var request=do_ajax_request(maintain_theme_in_link('/portalbeta/data/comcode_convert.php?css=1&javascript=1&raw_output=1&box_title=Preview'+keep_stub(false)),function(ajax_result_frame){if(ajax_result_frame&&ajax_result_frame.responseText)
...
{if(typeof window.cms_theme=='undefined')window.cms_theme='admin';if(typeof window.cms_lang=='undefined')window.cms_lang='EN';if((typeof win.document.querySelectorAll!='undefined')&&(typeof window.cms_lang!='undefined')&&(typeof window.cms_theme!='undefined'))
...
{cancel_bubbling(event);if(typeof event.preventDefault!='undefined')event.preventDefault();if(src.indexOf('/portalbeta/themes/')!=-1)
ob.edit_window=window.open('http://www.coeprobotics.com/portalbeta/adminzone/index.php?page=admin_themes&type=edit_image&lang='+window.encodeURIComponent(window.cms_lang)+'&theme='+window.encodeURIComponent(window.cms_theme)+'&url='+window.encodeURIComponent(src.replace('http://www.coeprobotics.com/portalbeta/',''))+keep_stub(),'edit_theme_image_'+ob.id);else window.fauxmodal_alert('The image you clicked is not a theme image, and thus must be edited by some alternative means.');return false;}
return true;}
...
{url+=window.encodeURIComponent('Robot Study Circle Portal'.replace(/[^a-zA-Z0-9\_\-\\\[\]{}\^`|]/g,''));}
...
{new Image().src='https://www.coeprobotics.com/portalbeta/themes/default/images/checklist/cross2.png';new Image().src='https://www.coeprobotics.com/portalbeta/themes/default/images/checklist/toggleicon2.png';var checklist_rows=get_elements_by_class_name(document,'checklist_row'),row_imgs,src;for(var i=0;i<checklist_rows.length;i++)
...
{load_snippet('checklist_task_manage','type=mark_done&id='+window.encodeURIComponent(id));ob.onclick=function(){mark_undone(ob,id);};ob.getElementsByTagName('img')[1].setAttribute('src','https://www.coeprobotics.com/portalbeta/themes/default/images/checklist/checklist1.png');}
function mark_undone(ob,id)
{load_snippet('checklist_task_manage','type=mark_undone&id='+window.encodeURIComponent(id));ob.onclick=function(){mark_done(ob,id);};ob.getElementsByTagName('img')[1].setAttribute('src','https://www.coeprobotics.com/portalbeta/themes/default/images/checklist/not_completed.png');}
