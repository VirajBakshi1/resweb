...
{if(window.page_loaded)return;var i;if(window==window.top&&!window.opener||window.name=='')window.name='_site_opener';if(typeof document.documentElement.ontouchstart!='undefined')document.body.className+=' touch_enabled';var preloader=new Image();var images=[];images.push('https://www.coeprobotics.com/portalbeta/themes/default/images/loading.gif'.replace(/^https?:/,window.location.protocol));for(i=0;i<images.length;i++)preloader.src=images[i];handle_textarea_scrolling();if((!window.parent)||(window.parent==window))
...
{window.done_one_error=true;var alert='An error occurred when loading this screen onto the web browser. You are being notified of this as you are staff. If you believe this is a bug in Robot Study Circle, please contact the developers with full details. More details are available in your browser\'s error console. The error was:\n\n'+code+': '+msg+'\n'+file;if(window.document.body)
...
if(read_cookie('hide_helper_panel')=='1')set_cookie('hide_helper_panel','0',100);helper_panel_toggle.onclick=function(){return helper_panel(false);};helper_panel_toggle.childNodes[0].src='https://www.coeprobotics.com/portalbeta/themes/default/images/icons/14x14/helper_panel_hide.png'.replace(/^https?:/,window.location.protocol);if(typeof helper_panel_toggle.childNodes[0].srcset!='undefined')
helper_panel_toggle.childNodes[0].srcset='https://www.coeprobotics.com/portalbeta/themes/default/images/icons/28x28/helper_panel_hide.png 2x'.replace(/^https?:/,window.location.protocol);}else
...
{panel_right.className+=' helper_panel_hidden';helper_panel_contents.setAttribute('aria-expanded','false');helper_panel_contents.style.display='none';set_cookie('hide_helper_panel','1',100);helper_panel_toggle.onclick=function(){return helper_panel(true);};helper_panel_toggle.childNodes[0].src='https://www.coeprobotics.com/portalbeta/themes/default/images/icons/14x14/helper_panel_show.png'.replace(/^https?:/,window.location.protocol);if(typeof helper_panel_toggle.childNodes[0].srcset!='undefined')
helper_panel_toggle.childNodes[0].srcset='https://www.coeprobotics.com/portalbeta/themes/default/images/icons/28x28/helper_panel_show.png 2x'.replace(/^https?:/,window.location.protocol);}
function sts(src)
...
{return(window.location+'').replace(/(^.*:\/\/[^\/]*)\/.*/,'$1')+'/portalbeta'.replace(/^.*:\/\/[^\/]*/,'');}
function confirm_session(callback)
{if(typeof window.do_ajax_request=='undefined')return;var url='/portalbeta/data/confirm_session.php'+keep_stub(true);require_javascript('ajax',window.do_ajax_request);if(typeof window.do_ajax_request=='undefined')return;var ret=do_ajax_request(url+keep_stub(true),function(ret){if(!ret)return;if(ret.responseText==='')
...
if(pic)
{if(matches_theme_image(pic.src,'https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expcon.png'))return false;if(matches_theme_image(pic.src,'https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expcon2.png'))return false;}
...
{set_tray_theme_image(pic,'expand','expcon','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expand.png','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expcon.png','https://www.coeprobotics.com/portalbeta/themes/default/images/2x/trays/expcon.png','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expcon2.png','https://www.coeprobotics.com/portalbeta/themes/default/images/2x/trays/expcon2.png');}
...
if(pic)
{set_tray_theme_image(pic,'expand','contract','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expand.png','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/contract.png','https://www.coeprobotics.com/portalbeta/themes/default/images/2x/trays/contract.png','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/contract2.png','https://www.coeprobotics.com/portalbeta/themes/default/images/2x/trays/contract2.png');}}}else
{if((type=='block')&&(element.nodeName.toLowerCase()=='div')&&(!no_animate)&&((!pic)||(pic.src.indexOf('themewizard.php')==-1)))
{if(pic)
{set_tray_theme_image(pic,'contract','expcon','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/contract.png','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expcon.png','https://www.coeprobotics.com/portalbeta/themes/default/images/2x/trays/expcon.png','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expcon2.png','https://www.coeprobotics.com/portalbeta/themes/default/images/2x/trays/expcon2.png');}
window.setTimeout(function(){begin_toggleable_tray_animation(element,-20,70,0,pic);},20);}else
{if(pic)
{set_tray_theme_image(pic,'contract','expand','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/contract.png','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expand.png','https://www.coeprobotics.com/portalbeta/themes/default/images/2x/trays/expand.png','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expand2.png','https://www.coeprobotics.com/portalbeta/themes/default/images/2x/trays/expand2.png');pic.setAttribute('alt',pic.getAttribute('alt').replace('Contract','Expand'));pic.title='Expand';pic.cms_tooltip_title='Expand';}
...
{if(animate_dif<0)
{set_tray_theme_image(pic,'expcon','expand','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expcon.png','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expand.png','https://www.coeprobotics.com/portalbeta/themes/default/images/2x/trays/expand.png','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expand2.png','https://www.coeprobotics.com/portalbeta/themes/default/images/2x/trays/expand2.png');}else
{set_tray_theme_image(pic,'expcon','contract','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/expcon.png','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/contract.png','https://www.coeprobotics.com/portalbeta/themes/default/images/2x/trays/contract.png','https://www.coeprobotics.com/portalbeta/themes/default/images/1x/trays/contract2.png','https://www.coeprobotics.com/portalbeta/themes/default/images/2x/trays/contract2.png');}
...
{if(url.indexOf('&utheme=')!=-1)return url;if(url.indexOf('?utheme=')!=-1)return url;if(url.indexOf('&keep_theme=')!=-1)return url;if(url.indexOf('?keep_theme=')!=-1)return url;if(typeof window.cms_theme=='undefined')window.cms_theme='admin';if(typeof window.cms_theme!='undefined')
...
{return read_cookie('cms_session__36eb71c89d53b5a9a9fb1df0d4dceec1');}
...
var _replace_spot=(template=='')?bit.parentNode.parentNode.parentNode.parentNode:replace_spot;set_inner_html(_replace_spot,'');var loading_image=document.createElement('img');loading_image.className='ajax_loading';loading_image.src='https://www.coeprobotics.com/portalbeta/themes/default/images/loading.gif'.replace(/^https?:/,window.location.protocol);loading_image.style.height='12px';_replace_spot.appendChild(loading_image);var snippet_request='rating&type='+window.encodeURIComponent(type)+'&id='+window.encodeURIComponent(id)+'&content_type='+window.encodeURIComponent(content_type)+'&template='+window.encodeURIComponent(template)+'&content_url='+window.encodeURIComponent(content_url)+'&content_title='+window.encodeURIComponent(content_title);var message=load_snippet(snippet_request,'rating='+window.encodeURIComponent(i),function(ajax_result){var message=ajax_result.responseText;set_outer_html(_replace_spot,(template=='')?('<strong>'+message+'</strong>'):message);});return false;}}(i);}}}
...
post+='&post='+window.encodeURIComponent(post_value);do_ajax_request('https://www.coeprobotics.com/portalbeta/data/post_comment.php'+keep_stub(true),function(ajax_result){if((ajax_result.responseText!='')&&(ajax_result.status!=500))
...
{form.elements['submit_button'].disabled=true;var url='https://www.coeprobotics.com/portalbeta/data/snippet.php?snippet=captcha_wrong&name='+window.encodeURIComponent(form.elements['captcha'].value);if(!do_ajax_field_test(url))
