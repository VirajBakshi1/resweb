...
if(read_cookie('hide_helper_panel')=='1')set_cookie('hide_helper_panel','0',100);helper_panel_toggle.onclick=function(){return helper_panel(false);};helper_panel_toggle.childNodes[0].src='https://www.coeprobotics.com/portalbeta/themes/RSC/images/icons/14x14/helper_panel_hide.png'.replace(/^https?:/,window.location.protocol);if(typeof helper_panel_toggle.childNodes[0].srcset!='undefined')
helper_panel_toggle.childNodes[0].srcset='https://www.coeprobotics.com/portalbeta/themes/RSC/images/icons/28x28/helper_panel_hide.png 2x'.replace(/^https?:/,window.location.protocol);}else
...
{panel_right.className+=' helper_panel_hidden';helper_panel_contents.setAttribute('aria-expanded','false');helper_panel_contents.style.display='none';set_cookie('hide_helper_panel','1',100);helper_panel_toggle.onclick=function(){return helper_panel(true);};helper_panel_toggle.childNodes[0].src='https://www.coeprobotics.com/portalbeta/themes/RSC/images/icons/14x14/helper_panel_show.png'.replace(/^https?:/,window.location.protocol);if(typeof helper_panel_toggle.childNodes[0].srcset!='undefined')
helper_panel_toggle.childNodes[0].srcset='https://www.coeprobotics.com/portalbeta/themes/RSC/images/icons/28x28/helper_panel_show.png 2x'.replace(/^https?:/,window.location.protocol);}
function sts(src)
...
if(pic)
{if(matches_theme_image(pic.src,'https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expcon.png'))return false;if(matches_theme_image(pic.src,'https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expcon2.png'))return false;}
...
{set_tray_theme_image(pic,'expand','expcon','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expand.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expcon.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/expcon.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expcon2.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/expcon2.png');}
...
if(pic)
{set_tray_theme_image(pic,'expand','contract','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expand.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/contract.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/contract.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/contract2.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/contract2.png');}}}else
{if((type=='block')&&(element.nodeName.toLowerCase()=='div')&&(!no_animate)&&((!pic)||(pic.src.indexOf('themewizard.php')==-1)))
{if(pic)
{set_tray_theme_image(pic,'contract','expcon','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/contract.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expcon.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/expcon.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expcon2.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/expcon2.png');}
window.setTimeout(function(){begin_toggleable_tray_animation(element,-20,70,0,pic);},20);}else
{if(pic)
{set_tray_theme_image(pic,'contract','expand','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/contract.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expand.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/expand.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expand2.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/expand2.png');pic.setAttribute('alt',pic.getAttribute('alt').replace('Contract','Expand'));pic.title='Expand';pic.cms_tooltip_title='Expand';}
...
{if(animate_dif<0)
{set_tray_theme_image(pic,'expcon','expand','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expcon.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expand.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/expand.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expand2.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/expand2.png');}else
{set_tray_theme_image(pic,'expcon','contract','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expcon.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/contract.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/contract.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/contract2.png','https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/contract2.png');}
...
{if(url.indexOf('&utheme=')!=-1)return url;if(url.indexOf('?utheme=')!=-1)return url;if(url.indexOf('&keep_theme=')!=-1)return url;if(url.indexOf('?keep_theme=')!=-1)return url;if(typeof window.cms_theme=='undefined')window.cms_theme='RSC';if(typeof window.cms_theme!='undefined')
