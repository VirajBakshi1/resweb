...
{pic.src=((pic.src.indexOf('themewizard.php')!=-1)?pic.src.replace('expand','contract'):'https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/contract.png').replace(/^https?:/,window.location.protocol);if(typeof pic.srcset!='undefined')
pic.srcset=((pic.srcset.indexOf('themewizard.php')!=-1)?pic.srcset.replace('expand','contract'):'https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/contract.png 2x').replace(/^https?:/,window.location.protocol);pic.setAttribute('alt','Contract');pic.setAttribute('title','Contract');new_state=(field_input.nodeName.toLowerCase()=='tr')?'table-row':'block';new_state_2='block';new_state_3='1px dashed';}else
{pic.src=((pic.src.indexOf('themewizard.php')!=-1)?pic.src.replace('contract','expand'):'https://www.coeprobotics.com/portalbeta/themes/RSC/images/1x/trays/expand.png').replace(/^https?:/,window.location.protocol);if(typeof pic.srcset!='undefined')
pic.srcset=((pic.src.indexOf('themewizard.php')!=-1)?pic.srcset.replace('contract','expand'):'https://www.coeprobotics.com/portalbeta/themes/RSC/images/2x/trays/expand.png 2x').replace(/^https?:/,window.location.protocol);pic.setAttribute('alt','Expand');pic.setAttribute('title','Expand');new_state='none';new_state_2='none';new_state_3='0';}
