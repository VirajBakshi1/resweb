...
{if(!authorised)
{var url='https://www.coeprobotics.com/portalbeta/data/upload_syndication_auth.php?hook='+window.encodeURIComponent(hook)+'&name='+window.encodeURIComponent(name)+keep_stub();faux_open(url,null,'width=960;height=500','_top');if(!pre_disabled)
