...
{var url='/portalbeta/'+this.object.hook+'&id='+window.encodeURIComponent(real_clicked_id)+'&options='+this.object.options+'&default='+window.encodeURIComponent(element.value);var ob=this.object;do_ajax_request(url,function(ajax_result_frame,ajax_result){set_inner_html(html_node,'');ob.response(ajax_result_frame,ajax_result,clicked_id);});set_inner_html(html_node,'<div aria-busy="true" class="vertical_alignment"><img src="'+'https://www.coeprobotics.com/portalbeta/themes/default/images/loading.gif'.replace(/^https?:/,window.location.protocol)+'" alt="" /> <span>Loading&hellip;</span></div>');var container=document.getElementById('tree_list__root_'+ob.name);if((automated)&&(container)&&(container.style.overflowY=='auto'))
...
expand_button.src='https://www.coeprobotics.com/portalbeta/themes/default/images/1x/treefield/collapse.png'.replace(/^https?:/,window.location.protocol);expand_button.srcset='https://www.coeprobotics.com/portalbeta/themes/default/images/2x/treefield/collapse.png'.replace(/^https?:/,window.location.protocol)+' 2x';expand_button.title=expand_button.title.replace('Expand','Contract');expand_button.alt=expand_button.alt.replace('Expand','Contract');}else
{var xml_node=this.object.getElementByIdHack(clicked_id,'c');xml_node.setAttribute('expanded','false');html_node.style.display='none';expand_button.src='https://www.coeprobotics.com/portalbeta/themes/default/images/1x/treefield/expand.png'.replace(/^https?:/,window.location.protocol);expand_button.srcset='https://www.coeprobotics.com/portalbeta/themes/default/images/2x/treefield/expand.png'.replace(/^https?:/,window.location.protocol)+' 2x';expand_button.title=expand_button.title.replace('Contract','Expand');expand_button.alt=expand_button.alt.replace('Contract','Expand');}
