...
{var cookie=read_cookie('use_wysiwyg');return((cookie=='')||(cookie!='0'))&&(browser_matches('wysiwyg')&&('1'!='1'));}
function wysiwyg_on()
...
set_inner_html(document.getElementById('toggle_wysiwyg_'+id),'<img src="https://www.coeprobotics.com/portalbeta/themes/default/images/icons/16x16/editor/wysiwyg_on.png" srcset="https://www.coeprobotics.com/portalbeta/themes/default/images/icons/16x16/editor/wysiwyg_on.png 2x" alt="Enable WYSIWYG editing" title="Enable WYSIWYG editing" class="vertical_alignment" />');try
{window.wysiwyg_editors[id].destroy();}
catch(e){}}}}
...
set_inner_html(document.getElementById('toggle_wysiwyg_'+id),'<img src="https://www.coeprobotics.com/portalbeta/themes/default/images/icons/16x16/editor/wysiwyg_off.png" srcset="https://www.coeprobotics.com/portalbeta/themes/default/images/icons/32x32/editor/wysiwyg_off.png 2x" alt="Disable WYSIWYG editing" title="Disable WYSIWYG editing" class="vertical_alignment" />');window.wysiwyg_original_comcode[id]=e.value;if(!ajax_copy)
...
{self_ob.tag_text=tag_text;self_ob.is_over=true;var url=maintain_theme_in_link('/portalbeta/data/comcode_convert.php?css=1&javascript=1&box_title=Preview'+keep_stub());if(window.location.href.indexOf('topics')!=-1)url+='&forum_db=1';var request=do_ajax_request(url,function(ajax_result_frame,ajax_result){if(ajax_result)
...
{if(!authorised)
{var url='https://www.coeprobotics.com/portalbeta/data/upload_syndication_auth.php?hook='+window.encodeURIComponent(hook)+'&name='+window.encodeURIComponent(name)+keep_stub();window.open(url);if(!pre_disabled)
