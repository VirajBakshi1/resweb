...
break;}
input.style.position='absolute';input.style.left='0px';input.style.width=get_window_width()+'px';input.style.top=(y+8)+'px';input.style.margin=0;var to_copy=['font-size','font-weight','font-style'];if(type=='line')
...
{var session_test_url='/portalbeta/data/confirm_session.php';var session_test_ret=do_ajax_request(session_test_url+keep_stub(true),null);if((session_test_ret.responseText!='')&&(session_test_ret.responseText!=null))
