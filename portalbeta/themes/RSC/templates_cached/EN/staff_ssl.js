...
{if(typeof window.cms_theme=='undefined')window.cms_theme='RSC';if(typeof window.cms_lang=='undefined')window.cms_lang='EN';if((typeof win.document.querySelectorAll!='undefined')&&(typeof window.cms_lang!='undefined')&&(typeof window.cms_theme!='undefined'))
...
{load_snippet('checklist_task_manage','type=mark_done&id='+window.encodeURIComponent(id));ob.onclick=function(){mark_undone(ob,id);};ob.getElementsByTagName('img')[1].setAttribute('src','https://www.coeprobotics.com/portalbeta/themes/RSC/images/checklist/checklist1.png');}
