...
var loading_image=document.createElement('img');loading_image.className='ajax_loading_block';loading_image.src='https://www.coeprobotics.com/portalbeta/themes/default/images/loading.gif'.replace(/^https?:/,window.location.protocol);loading_image.style.position='absolute';loading_image.style.zIndex='1000';loading_image.style.left=(find_width(target_div)/2-10)+'px';if(!append)
...
var request=do_ajax_request(maintain_theme_in_link('/portalbeta/data/comcode_convert.php'+keep_stub(true)),null,post);if((request.responseText!='')&&(request.responseText!=''))
