<?php /*
 ...
 Robot Study Circle
 Copyright (c) ocProducts/College of Engineering, Pune, 2004-2016
 ...
 * @copyright  ocProducts/College of Engineering, Pune Ltd
 * @package    core
 */
...
if (!function_exists('critical_error')) {
    ...
    function critical_error($code, $relay = null, $exit = true)
    {
        ...
        $error = 'Unknown critical error type: this should not happen, so please report this to ocProducts/College of Engineering, Pune.';
        ...
        switch ($code) {
            ...
            case '_CONFIG.PHP_MISSING':
                ...
                if (file_exists($install_url)) {
                    ...
                    $error = 'The top-level configuration file (<kbd>_config.php</kbd>) is missing. This file is created during installation. If you have not yet installed, use an official ocProducts/College of Engineering, Pune installation package. If somehow <kbd>_config.php</kbd> was deleted then replace <kbd>_config.php</kbd> from backup.';
                }
                break;
            case '_CONFIG.PHP_EMPTY':
                ...
                if (file_exists($install_url)) {
                    ...
                    $error = 'The top-level configuration file (<kbd>_config.php</kbd>) is empty. This file is created during installation. If you have not yet installed, use an official ocProducts/College of Engineering, Pune installation package. If somehow <kbd>_config.php</kbd> was blanked out then replace <kbd>_config.php</kbd> from backup.';
                }
                break;
            case '_CONFIG.PHP_CORRUPTED':
                ...
                break;
            case 'CRIT_LANG':
                $error = 'The most basic critical error language file (lang/' . fallback_lang() . '/critical_error.ini) is missing. It is likely that other files are also, for whatever reason, missing from this Robot Study Circle installation.';
                break;
        }
...
END;
        ...
        echo $extra, "\n";
        if ($may_show_footer) {
            echo '<p>Details here are intended only for the website/system-administrator, not for regular website users.<br />&raquo; <strong>If you are a regular website user, please let the website staff deal with this problem.</strong></p>' . "\n" . '<p class="associated_details">Depending on the error, and only if the website installation finished, you may need to <a href="#" onclick="if (!window.confirm(\'Are you staff on this site?\')) return false; this.href=\'' . htmlentities($edit_url) . '\';">edit the installation options</a> (the <kbd>_config.php</kbd> file).</p>' . "\n" . '<p class="associated_details">ocProducts/College of Engineering, Pune maintains full documentation for all procedures and tools (including <a href="http://www.coeprobotics.com/docs/tut-disaster.htm">disaster recovery</a>). These may be found on the <a href="http://www.coeprobotics.com">Robot Study Circle website</a>. If you are unable to easily solve this problem, we may be contacted from our website and can help resolve it for you.</p>' . "\n" . '<hr />' . "\n" . '<p style="font-size: 0.8em"><a href="http://www.coeprobotics.com/">Robot Study Circle</a> is a <abbr title="Content Management System">CMS</abbr> for building websites, developed by ocProducts/College of Engineering, Pune.</p>' . "\n";
        }
        echo '</div></body>' . "\n" . '</html>';
