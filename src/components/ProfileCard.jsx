    ...
    <div className="relative group max-w-lg mx-auto">
      ...
      <div className="relative bg-gradient-to-b from-gray-900 to-black border-l-2 border-t-2 
        ...
        <div className="absolute -top-1 -left-1 w-8 h-8 bg-gradient-to-bl from-blue-500 to-purple-600">
          <div className="absolute top-0 left-0 w-4 h-4 bg-black transform rotate-45 
            -translate-x-1/2 -translate-y-1/2"></div>
        </div>
        
        {/* Profile image container */}
        <div className="relative mb-6 group-hover:transform group-hover:scale-[1.01] 
          transition-all duration-500">
          <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500 via-blue-500 
            to-purple-600 opacity-75 rounded-full blur-md transition-all duration-500"></div>
          <div className="relative rounded-full p-1 bg-gradient-to-r from-cyan-500 
        ...
        <div className="text-center space-y-3">
          <h2 className="text-2xl w-48 text-center m-auto font-bold bg-gradient-to-r from-cyan-400 via-blue-400 
            to-purple-400 bg-clip-text text-transparent px-2 break-words min-h-[4rem] 
              ...
              >
                <div className="relative group/icon">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-cyan-600 
                    opacity-50 blur-sm group-hover/icon:opacity-100 transition-all duration-300"></div>
                  <svg
