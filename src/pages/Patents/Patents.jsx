    ...
    >
      ...
      <div className="relative h-full bg-black border-l-2 border-t-2 border-blue-500/30 p-6">
        ...
        <div className="flex flex-col h-full">
          {/* Title with gradient and award badge */}
          <h3 className="text-lg font-bold mb-3">
            ...
            >
              {paper.title}
              {paper.award && (
                <span className="ml-2 inline-flex items-center px-3 py-1 text-xs font-medium relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-yellow-400 to-orange-400 
                    opacity-90 blur-sm"></div>
                  <span className="relative text-black">{paper.award}</span>
                </span>
              )}
            </a>
          </h3>
          
          {/* Authors with hover effect */}
...
const Patents = () => {
  const patentsData = data.Achievements.Patents.PatentsData;
  ...
  return (
    <div className="bg-black text-white p-8 py-16">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Conference sections */}
        {patentsData.map((conference, index) => (
