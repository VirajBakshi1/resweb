  ...
  return (
    <div className="min-h-screen bg-black text-white py-12 px-6">
      ...
      <div className="flex flex-col items-center">
        <img src="/src/assets/trslogo.png" alt="The Robotics Society Logo" className="h-14 mb-6" />
        <h1 className="text-6xl text-blue-300 font-bold mb-4 text-center">The Robotics Society</h1>
      </div>
